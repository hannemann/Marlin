...
#define CUSTOM_MACHINE_NAME "Hannemann's Anet A6"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100,  100, 400, 190}
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 33, 0, -0.25 }
...
#define HOMING_FEEDRATE_Z  (3*60) // Bigger Values cause bad noises
...
#define LCD_FEEDBACK_FREQUENCY_HZ 2600
